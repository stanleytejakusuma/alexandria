...
| **1** | Chunker · embeddings · LanceDB · hybrid + rerank · search API | **Golden query set passes** · full rebuild time [not yet re-measured against the current corpus size — see `SECURITY.md`](SECURITY.md#recovery-time-objective-rto) · p50 < 500 ms |
